...
ath.intl = {
	...
	en_us: {
		message: 'Need to add this web app to the home screen: tap %icon and then <strong>%action</strong>.',
	...
	fr_fr: {
		message: 'Pour une expérience optimale, il faut ajouter cette application sur votre écran d\'accueil : Appuyez sur %icon et sélectionnez <strong>%action</strong>.',
...
// default options
ath.defaults = {
	appID: 'com.kiteassit',		// local storage name (no need to change)
	...
	displayPace: ,			// minutes before the message is shown again (0: display every time, default 24 hours)
